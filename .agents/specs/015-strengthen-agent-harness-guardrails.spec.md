# SPEC-015: Strengthen agent harness guardrails
...
Skills, workflows, hooks, and harness-score needed discoverable activation.
...
Declare SKILL/rule frontmatter, four workflows, Cursor hooks, and L4 harness-score 1.5.2.
