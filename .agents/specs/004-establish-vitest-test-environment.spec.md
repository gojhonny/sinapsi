# SPEC-004: Establish Vitest environment
...
DOM and SSR tests needed a deterministic runner.
...
Configure Vitest + happy-dom, Node SSR import test, and canvas stubs in test/setup.ts.
