# SPEC-005: Palette and public properties
...
Consumers needed a small, recoverable public contract.
...
Expose color-primary/text/muted, move, speed, nodes, and activation with console.error recovery.
